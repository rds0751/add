# Generated by Django 2.1.4 on 2018-12-29 04:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', django_prices.models.MoneyField(currency='INR', decimal_places=2, default=0, max_digits=12)),
                ('minimum_order_price', django_prices.models.MoneyField(blank=True, currency='INR', decimal_places=2, default=0, max_digits=12, null=True)),
                ('maximum_order_price', django_prices.models.MoneyField(blank=True, currency='INR', decimal_places=2, max_digits=12, null=True)),
